...
@InputType()
class KeywordCreateNestedManyWithoutDetectionsInput {
...
export { KeywordCreateNestedManyWithoutDetectionsInput as KeywordCreateNestedManyWithoutDetectionsInput };
