...
export class DetectionResolverBase {
  ...
  @graphql.ResolveField(() => [Keyword], { name: "keywords" })
  async findKeywords(
    @graphql.Parent() parent: Detection,
  ...
  @graphql.ResolveField(() => [Occurrence], { name: "occurrences" })
  async findOccurrences(
    @graphql.Parent() parent: Detection,
    @graphql.Args() args: OccurrenceFindManyArgs
  ): Promise<Occurrence[]> {
    const results = await this.service.findOccurrences(parent.id, args);
